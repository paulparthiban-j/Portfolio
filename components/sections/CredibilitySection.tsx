        ...
        <section className="py-24 px-6 md:px-12 bg-black relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-7xl relative z-10">
                <ScrollSection animationType="slide-down" className="mb-20 text-center">
                    <h2 className="text-5xl md:text-8xl font-black tracking-tighter text-white mb-4 uppercase leading-none">
                        Proof of Impact
                    </h2>
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-12">
                        ...
                        <div>
                            <h3 className="text-xs font-black tracking-[0.3em] text-indigo-500 uppercase mb-8">Continuous Deployment</h3>
                            <div className="p-8 bg-indigo-600 rounded-3xl shadow-2xl shadow-indigo-500/20 group hover:scale-[1.02] transition-all cursor-pointer">
