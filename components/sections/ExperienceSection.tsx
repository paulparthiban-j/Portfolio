                            ...
                            >
                                ...
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                                    ...
                                    <div className="shrink-0 flex items-start">
                                        <span className="text-[10px] md:text-xs font-black text-indigo-400 bg-indigo-500/10 border border-indigo-500/20 px-3 py-1 sm:px-4 sm:py-2 rounded-xl uppercase tracking-[0.2em] whitespace-nowrap shadow-xl shadow-indigo-500/5">
                                            {exp.duration}
                                        </span>
                                    </div>
                                </div>
